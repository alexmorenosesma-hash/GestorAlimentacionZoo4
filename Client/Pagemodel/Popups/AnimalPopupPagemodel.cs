...
public partial class AnimalPopupPagemodel : ObservableObject
{
    [ObservableProperty]
    ...
    [ObservableProperty]
    public Animal _model = new()
    {
        idAnimal   = null
    };

    IRealtimeService _db;
    ...
    public AnimalPopupPagemodel(IPopupService popup,IEspecieRepository especieRepository,IDietaRepository dietaRepository,IHorarioRepository horarioRepository,IEnfermedadRepository enfermedadRepository,ICuidadorRepository cuidadorRepository,IServiceProvider serviceProvider)
    {
        _popup = popup;
        ...
        CargarNombresEspecies();
        CargarNombresDietas();
        CargarNombresCuidadores();
    }
