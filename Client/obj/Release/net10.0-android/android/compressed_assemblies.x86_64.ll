...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [149 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2237952, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 18519528; uint32_t buffer_offset
	}, ; 146: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 18690536; uint32_t buffer_offset
	}, ; 147: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2024448, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 18713096; uint32_t buffer_offset
	} ; 148: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 20737544, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [20737544 x i8] zeroinitializer, align 16
